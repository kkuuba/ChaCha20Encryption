...
class WebCam:
    ...
    def __init__(self):
        self.frames = []
        self.thread = None
        self.camera = cv2.VideoCapture("small.mp4") # Here will be 0 in webcam case
    ...
    def get_frame(self):
        # TODO Here should be some code to cipher this frame with chacha20 class. This returned element of list is in bytes so it won't be a problem. 
